    ...
    fields: [
      {
        ...
        label: "The statistic",
        type: "textarea",
        placeholder: "the number of active crypto wallets in the US",
    ...
    fields: [
      {
        ...
        label: "Topic",
        type: "text",
        placeholder: "small business lending in the US",
...

  {
    ...
    fields: [
      ...
      },
      {
        ...
        label: "Address",
        type: "text",
        placeholder: "1200 S Congress Ave",
...

  {
    ...
    fields: [
      ...
      },
      {
        ...
        label: "Business name",
        type: "text",
        placeholder: "Intelligentsia Coffee",
      ...
      },
      {
        ...
        label: "Address",
        type: "text",
        placeholder: "233 N Michigan Ave",
...

  {
    ...
    fields: [
      ...
      },
      {
        ...
        label: "Product",
        type: "text",
        placeholder: "Cheerios, 12 oz box",
...

  {
    ...
    fields: [
      ...
      },
      {
        ...
        label: "Venue",
        type: "text",
        placeholder: "The Studio, 5th and Main",
